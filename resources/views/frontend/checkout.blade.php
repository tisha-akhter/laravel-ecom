                                ...
                                <div class="order-summary-content">
                                    ...
                                    <div class="order-summary-table table-responsive text-center">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="{{url('/product/details')}}">Suscipit Vestibulum <strong> ×
                                                                1</strong></a>
                                                    </td>
                                                    <td>$165.00</td>
                                                </tr>
                                                <tr>
                                                    <td><a href="{{url('/product/details')}}">Ami Vestibulum suscipit <strong> ×
                                                                4</strong></a>
                                                    </td>
                                                    <td>$165.00</td>
                                                </tr>
                                                <tr>
                                                    <td><a href="{{'/product/details'}}">Vestibulum suscipit <strong> ×
                                                                2</strong></a>
                                                    </td>
                                                    <td>$165.00</td>
                                                </tr>
                                            ...
                                            <div class="payment-method-name">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="paypalpayment">Paypal <img
                                                            src="{{asset('frontend/assets/img/paypal-card.jpg')}}" class="img-fluid paypal-card"
                                                            alt="Paypal" /></label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="summary-footer-area">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="terms"
                                                    required />
                                                <label class="custom-control-label" for="terms">I have read and agree
                                                    to the
                                                    website
                                                    <a href="{{'/'}}">terms and conditions.</a></label>
                                            </div>

                                            <a href="{{url('/checkout')}}" class="btn-add-to-cart"> Place Order</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
